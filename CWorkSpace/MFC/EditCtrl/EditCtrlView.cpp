...
BEGIN_MESSAGE_MAP(CEditCtrlView, CFormView)
	...
	ON_EN_MAXTEXT(IDC_EDIT, &CEditCtrlView::OnEnMaxtextEdit)
	ON_EN_CHANGE(IDC_EDIT, &CEditCtrlView::OnEnChangeEdit)
END_MESSAGE_MAP()
...
void CEditCtrlView::OnEnChangeEdit()
{
	CString str;
...
void CEditCtrlView::OnEnMaxtextEdit()
{
