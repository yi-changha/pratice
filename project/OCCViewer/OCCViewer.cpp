...
// OCCViewer.cpp: 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BOOL COCCViewerApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_OCCViewerTYPE,
